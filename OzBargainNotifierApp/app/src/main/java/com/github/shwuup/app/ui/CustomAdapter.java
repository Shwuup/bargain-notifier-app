...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
    ...
    public CustomAdapter(List<String> keywordData) {
        keywords = new SortedList<String>(String.class, new SortedListAdapterCallback<String>(this) {
            @Override
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        KeywordFileManager keywordFileManager = new KeywordFileManager(viewHolder.getView().getContext());
        ...
        RxView.clicks(delete).map(x -> new Event("delete", keyword))
