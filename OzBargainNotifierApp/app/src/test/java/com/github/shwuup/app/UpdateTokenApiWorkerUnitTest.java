...
public class UpdateTokenApiWorkerUnitTest {
    @Rule
    ...
    public void testCreateWork_success() throws InterruptedException {
        ...
        String token = "testNewToken";
        String oldToken = "testOldToken";
        Single<Response<ResponseBody>> call = service.addToken(new Token(token, oldToken));
        ...
        Data inputData = new Data.Builder()
                ...
                .putString("Old Token", oldToken)
                .build();

        when(workerParams.getInputData()).thenReturn(inputData);
        worker = new UpdateTokenApiWorker(context, workerParams, tokenApiManager);
